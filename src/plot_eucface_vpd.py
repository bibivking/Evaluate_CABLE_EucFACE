...
"""
Draw Etr_cable vs Etr_obs classified by VPD
...
def plot_vpd(fcable, ring):
    ...
    ax1.text(0.82, 0.42, '$D$ (kPa)', c = almost_black, transform=ax1.transAxes,
             fontsize=14, verticalalignment='top', bbox=props)
    ax1.legend(loc='best', frameon=False)

    fig.savefig("./plots/EucFACE_Trans_VPD" , bbox_inches='tight', pad_inches=0.1)
